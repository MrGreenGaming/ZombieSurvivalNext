...
if CLIENT then
	function SWEP:DrawHUD()
		...
		draw.SimpleText ( Description1,"ZSHUDFontSmaller",ScaleW(673),ScaleH(876), Color ( 100,255,100,255 ), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER )
		draw.SimpleText ( Description2 ,"ZSHUDFontSmaller",ScaleW(673),ScaleH(906), Color ( 240,240,240,255 ), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER )
		draw.SimpleText ( Description3 ,"ZSHUDFontSmaller",ScaleW(673),ScaleH(938), Color ( 240,240,240,255 ), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER )
