...
SWEP.ViewModelBoneMods = {
	...
	SWEP.VElements = {
		...
		--["vodka"] = { type = "Model", model = "models/props_junk/garbage_glassbottle003a.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(4, -2.2, -0.9), angle = Angle(0.688, -4.676, 180.695), size = Vector(0.736, 0.736, 0.736), color = Color(160, 160, 160, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
	}
...
function SWEP:DrawHUD()
	...
	draw.SimpleText("Bottle o'l Vodka", "ZSHUDFont", ScrW() - nTEXW * 0.4 - 24, ScrH() - nTEXH * 2, nails > 0 and COLOR_GREY or COLOR_GREY, TEXT_ALIGN_CENTER)
