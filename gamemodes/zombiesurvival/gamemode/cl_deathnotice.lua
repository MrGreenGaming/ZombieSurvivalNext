...
killicon.Add("weapon_zs_ticklemonster", "killicon/zs_zombie", color_white)
killicon.Add("weapon_zs_bonemesh", "killicon/zs_zombie", color_white)
...
killicon.AddFont("weapon_zs_mine", "zsdeathnotice", "*", color_white)
...
killicon.AddFont("weapon_zs_boomsticker", "zsdeathnotice", "0", color_white)
...
killicon.AddFont("weapon_zs_slugrifle", "zsdeathnoticecs", "w", color_white)
...
killicon.AddFont("weapon_zs_sledgehammer","zsdeathnotice2", "e", color_white)
...
net.Receive("zs_playerredeemed", function(length)
	...
	if pl:IsValid() then
		...
		if pl == MySelf then
			GAMEMODE:CenterNotify(COLOR_RED, translate.Get("you_redeemed"))
		end
	end
end)
