...
function Sheet_MapCycle()
	...
	DMapPropLabel.Paint = function()
		draw.SimpleTextOutlined ( "Map name", "ZSHUDFontSmall", DMapPropLabel:GetWide()/2, DMapPropLabel:GetTall()/2, Color(255, 255, 255, 255) , TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER,1,Color(0,0,0,255))
	end
	...
	DMapPropLabel2.Paint = function()
		draw.SimpleTextOutlined ( "Map filename", "ZSHUDFontSmall", DMapPropLabel2:GetWide()/2, DMapPropLabel2:GetTall()/2, Color(255, 255, 255, 255) , TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER,1,Color(0,0,0,255))
	end
	...
	DMapPropLabel3.Paint = function()
		draw.SimpleTextOutlined ( "-------------Add new map-------------", "ZSHUDFontSmall", DMapPropLabel3:GetWide()/2, DMapPropLabel3:GetTall()/2, Color(255, 255, 255, 255) , TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER,1,Color(0,0,0,255))
	end
...
function RebuildMapCycle()
	...
	for i=1, #MapCycle_cl do
		...
		MapTab[i].Paint = function()
			...
			-- index
			draw.SimpleTextOutlined ( i, "ZSHUDFontSmall", 5, MapTab[i]:GetTall()*0.25, Color(255, 255, 255, 255) , TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER,1,Color(0,0,0,255))
					
			--Pretty Name if exists
			draw.SimpleTextOutlined ( MapCycle_cl[i].MapName, "ZSHUDFontSmall", 25, MapTab[i]:GetTall()*0.25, Color(255, 255, 255, 255) , TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER,1,Color(0,0,0,255))
			...
			--Actual filename
			draw.SimpleTextOutlined ( MapCycle_cl[i].Map .. ExtraStr, "ZSHUDFontSmall", 25, MapTab[i]:GetTall()*0.75, col, TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER,1, borderCol)
			...
			for k, v in pairs(remove) do
				...
				PropTab[MapSelectedProp].Rmv[v].Paint = function()
					if PropTab[MapSelectedProp].Rmv[v].Overed then
						draw.SimpleTextOutlined ( "[X]", "ZSHUDFontSmall", PropTab[MapSelectedProp].Rmv[v]:GetWide()-25, PropTab[MapSelectedProp].Rmv[v]:GetTall()/2, Color(255, 255, 255, 255) , TEXT_ALIGN_RIGHT, TEXT_ALIGN_CENTER,1,Color(0,0,0,255))
					end
				end
			...
			for k, v in pairs(exclude) do
				...
				PropTab[MapSelectedProp].Ex[v].Paint = function()
					if PropTab[MapSelectedProp].Ex[v].Overed then
						draw.SimpleTextOutlined ( "[X]", "ZSHUDFontSmall", PropTab[MapSelectedProp].Ex[v]:GetWide()-25, PropTab[MapSelectedProp].Ex[v]:GetTall()/2, Color(255, 255, 255, 255) , TEXT_ALIGN_RIGHT, TEXT_ALIGN_CENTER,1,Color(0,0,0,255))
					end
				end
			...
			for k, v in pairs(removemdl) do
				...
				PropTab[MapSelectedProp].Mdl[v].Paint = function()
					if PropTab[MapSelectedProp].Mdl[v].Overed then
						draw.SimpleTextOutlined ( "[X]", "ZSHUDFontSmall", PropTab[MapSelectedProp].Mdl[v]:GetWide()-25, PropTab[MapSelectedProp].Mdl[v]:GetTall()/2, Color(255, 255, 255, 255) , TEXT_ALIGN_RIGHT, TEXT_ALIGN_CENTER,1,Color(0,0,0,255))
					end
				end
...
function RebuildMapProperties()
	...
	for map, stuff in pairs(MapProperties_cl) do
		...
		PropTab[map].Paint = function()
			...
			draw.SimpleTextOutlined ( map, "ZSHUDFontSmall", 10, PropTab[map]:GetTall()/2, Color(255, 255, 255, 255) , TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER,1,Color(0,0,0,255))
		...
		for i,filename in pairs(file.Find("zombiesurvival/crates/*.txt","DATA")) do
			...
			CrateLabel[name].Paint = function()
				if CrateLabel[name].Overed then
					draw.SimpleTextOutlined ( "<<-------[Press to upload]", "ZSHUDFontSmall", CrateLabel[name]:GetWide()-105, CrateLabel[name]:GetTall()/2, Color(255, 255, 255, 255) , TEXT_ALIGN_RIGHT, TEXT_ALIGN_CENTER,1,Color(0,0,0,255))
				end
				if CrateLabel[name].Uploaded then
					draw.SimpleTextOutlined ( "<-Uploaded!->", "ZSHUDFontSmall", CrateLabel[name]:GetWide()-25, CrateLabel[name]:GetTall()/2, Color(255, 255, 255, 255) , TEXT_ALIGN_RIGHT, TEXT_ALIGN_CENTER,1,Color(0,0,0,255))
				end
				draw.SimpleTextOutlined ( name, "ZSHUDFontSmall", 35, CrateLabel[name]:GetTall()/2, Color(255, 255, 255, 255) , TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER,1,Color(0,0,0,255))			
			end
		...
		for i,filename in pairs(file.Find("zombiesurvival/exploits/*.txt","DATA")) do
			...
			ExploitLabel[name].Paint = function()
				if ExploitLabel[name].Overed then
					draw.SimpleTextOutlined ( "<<-------[Press to upload]", "ZSHUDFontSmall", ExploitLabel[name]:GetWide()-105, ExploitLabel[name]:GetTall()/2, Color(255, 255, 255, 255) , TEXT_ALIGN_RIGHT, TEXT_ALIGN_CENTER,1,Color(0,0,0,255))
				end
				if ExploitLabel[name].Uploaded then
					draw.SimpleTextOutlined ( "<-Uploaded!->", "ZSHUDFontSmall", ExploitLabel[name]:GetWide()-25, ExploitLabel[name]:GetTall()/2, Color(255, 255, 255, 255) , TEXT_ALIGN_RIGHT, TEXT_ALIGN_CENTER,1,Color(0,0,0,255))
				end
				draw.SimpleTextOutlined ( name, "ZSHUDFontSmall", 35, ExploitLabel[name]:GetTall()/2, Color(255, 255, 255, 255) , TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER,1,Color(0,0,0,255))			
			end
