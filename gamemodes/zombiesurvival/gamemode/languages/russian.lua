...
LANGUAGE.next_wave_in_x								= "До след. волны: %s"
LANGUAGE.wave_ends_in_x								= "До конца волны: %s"
...
LANGUAGE.next_round_in_x							= "До след. раунда: %s"
...
LANGUAGE.controls_howler							= "> ОСНОВНАЯ: Howl Push\n> ДОПОЛНИТЕЛЬНАЯ: Howl Pull"
