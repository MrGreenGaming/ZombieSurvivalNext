...
GM:AddPointShopItem("boomstick", "Boom Stick", nil, ITEMCAT_GUNS3, 370, "weapon_zs_boomerstick") --Duby: We have the Mr.Green one! ^^
...
GM:AddPointShopItem("katana", "Katana", nil, ITEMCAT_MELEE, 140, "weapon_zs_katana")
